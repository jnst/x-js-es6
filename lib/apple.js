...
exports.scan = function() {
  request(json => {
    const stockedModelIds1 = scanByStore(json, Store.SHIBUYA);
    const stockedModelIds2 = scanByStore(json, Store.OMOTESANDO);
    const stockedModelIds3 = scanByStore(json, Store.GINZA);
    printModels(Store.SHIBUYA, stockedModelIds1);
    printModels(Store.OMOTESANDO, stockedModelIds2);
    printModels(Store.GINZA, stockedModelIds3);
    if (!_.isEmpty(stockedModelIds1) || !_.isEmpty(stockedModelIds2) || !_.isEmpty(stockedModelIds3)) {
